...
/* 
         Sesión 01-11.
         Problema número 4:
           Programa para ver cuantas veces aparece una letra en la secuencia.
*/
/*********************************************************************/
...
//Función que recibe un mensage string y devuelve un caracter filtrado.
...
class Letra{
	...
	public:
		...
		void Total_Apariciones(){
			...
			cout << endl << endl << "Total de apariciones...\n";
